        ...
        <div className="space-y-6 animate-in fade-in duration-500">
            ...
            <div className="space-y-3">
                {[
                    ...
                    <div key={user.email} className="flex items-center justify-between p-4 bg-white border border-gray-100 rounded-lg hover:border-blue-100 transition-all group shadow-sm">
                        ...
                        <div className="flex items-center gap-6">
                            <div className="text-right hidden md:block">
                                ...
                                <p className="text-[10px] font-black text-blue-900 uppercase tracking-widest">{user.access}</p>
                            </div>
