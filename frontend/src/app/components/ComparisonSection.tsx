    ...
    return (
        <section className="py-24 px-4 sm:px-6 lg:px-8 bg-white relative overflow-hidden">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full max-w-4xl opacity-5 pointer-events-none">
                ...
                <div className="absolute bottom-0 right-0 w-64 h-64 bg-blue-900 rounded-full blur-[120px]" />
            </div>
            ...
            <div className="container mx-auto relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-20">
                    <ScrollReveal direction="bottom">
                        <h2 className="text-5xl sm:text-6xl font-extrabold mb-6 tracking-tight">
                            Multipliez votre <span className="text-blue-900">productivité par 10</span>
                        </h2>
                ...
                <div className="grid lg:grid-cols-2 gap-8 items-stretch">
                    <ScrollReveal direction="right" className="group p-8 bg-gray-50 border border-gray-100 rounded-xl hover:bg-white hover:border-red-100 transition-all duration-500 hover:shadow-xl">
                    ...
                    <ScrollReveal direction="left" className="group p-8 bg-blue-600 text-white rounded-xl shadow-2xl shadow-blue-500/10 relative overflow-hidden transform hover:-translate-y-1 transition-all duration-500">
                        <div className="absolute top-0 right-0 w-64 h-64 bg-white/10 blur-3xl -translate-y-1/2 translate-x-1/2" />
                        <div className="absolute bottom-0 left-0 w-32 h-32 bg-blue-800/20 blur-3xl translate-y-1/2 -translate-x-1/2" />
