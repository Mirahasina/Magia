...
export function CTASection({ onAction, onContact }: CTASectionProps) {
    ...
    <>
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-blue-950 text-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-40 mix-blend-screen">
          <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-blue-900 rounded-full blur-[120px] animate-pulse"></div>
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-blue-800/20 rounded-full blur-[100px]"></div>
        </div>
        ...
        <ScrollReveal className="container mx-auto relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8 bg-white/5 backdrop-blur-xl border border-white/10 p-12 md:p-20 rounded-3xl shadow-2xl relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-500 via-blue-800 to-blue-800 animate-shine"></div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
              <Button
                ...
                onClick={onAction}
              >
                <div className="absolute inset-0 bg-gradient-to-r from-blue-100 via-blue-100 to-blue-100 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
