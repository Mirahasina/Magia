            ...
            return (
              <Card key={index} className="relative p-10 bg-white/80 backdrop-blur-sm border-gray-100 shadow-sm hover-neon transition-all duration-500 group overflow-hidden">
                <div className="absolute top-0 right-0 p-4 opacity-10 blur-xl group-hover:opacity-40 transition-opacity">
                  <Icon className="w-24 h-24 text-blue-900" />
                </div>
                <div className="mb-6 relative z-10">
                  <div className="w-14 h-14 bg-gradient-to-br from-blue-800/10 to-blue-900/10 border border-blue-100 group-hover:border-blue-400 rounded-xl flex items-center justify-center transition-all duration-300 shadow-[inset_0_0_15px_rgba(79,70,229,0.1)] group-hover:shadow-[inset_0_0_20px_rgba(79,70,229,0.3)]">
                    <Icon className="w-6 h-6 text-blue-900" />
                  </div>
                </div>
                <h3 className="text-xl font-bold mb-3 group-hover:text-blue-900 transition-colors relative z-10">{feature.title}</h3>
