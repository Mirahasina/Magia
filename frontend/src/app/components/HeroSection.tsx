          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="flex flex-col justify-center space-y-8">
              <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold leading-[1.1] tracking-tight">
                ...
                <span className="bg-gradient-to-r from-blue-600 via-blue-900 to-blue-900 bg-clip-text text-transparent">
                  commerciale
                </span>{" "}
                IA en 24h
              </h1>
              ...
              <div className="flex gap-4">
                <Button
                  size="lg"
                  variant="outline"
                  className="hover:scale-105 transition-all shadow-sm hover:shadow-lg border-2 border-blue-100 hover:border-blue-400 rounded-xl"
