...
export function VideoSection() {
  ...
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-900 via-blue-900 to-blue-950 text-white relative overflow-hidden">
      {/* Top Transition */}
      ...
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-1/4 left-1/3 w-96 h-96 bg-blue-800 rounded-full blur-3xl animate-pulse"></div>
        ...
        <div className="max-w-5xl mx-auto">
            ...
            {!isPlaying && (
              <div className="absolute inset-0 flex items-center justify-center bg-black/40 backdrop-blur-sm cursor-pointer transition-all group-hover:bg-black/50" onClick={handlePlayClick}>
                <div className="relative">
                  ...
                  {/* Play button */}
                  <div className="relative w-24 h-24 bg-gradient-to-br from-blue-900 to-blue-600 rounded-full flex items-center justify-center shadow-2xl transform transition-transform group-hover:scale-110">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-12">
            <div className="text-center p-6 bg-white/5 rounded-xl backdrop-blur-sm border border-white/10">
              <div className="w-12 h-12 bg-gradient-to-br from-blue-800 to-blue-500 rounded-lg flex items-center justify-center mx-auto mb-3">
